...
def add_emp(request):
	if request.method == 'POST':
		...
		new_emp = Employee(emp_id = emp_id, first_name= first_name, last_name= last_name, age = age , sal = sal, bonus = bonus, phone = phone, email = email, dept_id = dept, role_id = role, hire_date = datetime.now())
		new_emp.save()
